...
try:
  with open(r"C:\Repository\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV\Space_ROIs",
              'rb') as f:
...
while True:
    img = cv2.imread(r"C:\Repository\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV\data\ROI_Reference.png")
