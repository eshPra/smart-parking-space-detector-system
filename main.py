...
from utilis.utilis import YOLO_Detection, drawPolygons, label_detection
import pickle
...
model = YOLO(r"C:\Repository\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV\models\yolov8n.pt")
model.to(device)

# Load the positions from the pickle file
with open(r'C:\Repository\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV\Space_ROIs', 'rb') as f:
    posList = pickle.load(f)

# Capture from camera or video
cap = cv2.VideoCapture(r"C:\Repository\Smart-Parking-Space-Detector-using-YOLO-and-OpenCV\data\parking_space.mp4")  # Change to the appropriate source if not using a webcam
# get vcap property
